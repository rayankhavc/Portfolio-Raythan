        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-10 text-zinc-400 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1 list-none pl-0">
              ...
              <li><span className="text-zinc-500">SIRET :</span> <span className="text-zinc-400">[SIret pas ezncore ]</span></li>
              <li><span className="text-zinc-500">Adresse :</span> <span className="text-zinc-400">[44 rue du pas brédy]</span></li>
